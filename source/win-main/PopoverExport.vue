...
const loadWorkplaceProfiles = computed(() => configStore.config.workspaces.loadAllAssets && configStore.config.workspaces.loadExportProfiles)
...
function doExport (): void {
  ...
  if (hasCommand !== undefined) {
    ...
    ipcRenderer.invoke('application', {
      ...
      payload: {
        displayName: commandProfile?.displayName,
        file: props.filePath
      }
    })
      .finally(() => {
